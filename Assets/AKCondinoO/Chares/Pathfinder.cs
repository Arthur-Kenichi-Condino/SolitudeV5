...
commands3ciB=new NativeList<RaycastCommand>(Allocator.Persistent),results3ciB=new NativeList<RaycastHit>(Allocator.Persistent),},TaskCreationOptions.LongRunning);
}
bool Stop{
